...
public class NLPExample {
	...
	public static void POSTag() throws IOException {
		...
		while ((line = lineStream.read()) != null) {
			...
			/*String[] chunks = chunker.chunk(sample.getSentence(),
					sample.getTags());

		        System.out.println(new ChunkSample(sample.getSentence(),
		        		sample.getTags(), chunks).nicePrint());
			*/
	...
	public static void chunk() throws IOException {
		...
		for (String s : result){
			...
			System.out.println("PRINTTTTTTTTTING");
	...
	public static void Parse() throws InvalidFormatException, IOException {
		...
		for (Parse p : topParses){
			p.show();
			System.out.println("TYPE EQUALS " + p.getType());}
